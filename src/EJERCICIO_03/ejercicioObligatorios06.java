...
//Para hacerlo más sencillo vamos a suponer que el mes tiene 28 días y está formado por 4 semanas de 7 días.
...
//System.out.println(mes);
    ...
    public static void diasMasCalurosos(ArrayList< ArrayList< Integer>> mes, String[] dias) {
        ...
        System.out.println("El " + di + " de la semana " + se + " es el mÃ¡s caluroso: " + mayor + "Âºc");
    }
