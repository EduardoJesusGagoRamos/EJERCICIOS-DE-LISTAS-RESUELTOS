//Diseña un programa que almacene en una lista de objetos de la clase ENERO las temperaturas medias del mes de Enero (31 días) que introduzca un usuario.
//Cada objeto tendrá los siguientes atributos:
...
public class Enero {
    ...
    public void rellenarDia() {
        ...
        System.out.println("DÃ­a del mes: ");
    ...
    public void rellenarDiaSemana() {
        Scanner teclado = new Scanner(System.in);
        System.out.println("DÃ­a de la semana: ");
    ...
    public static void mostrarTemperaturas(ArrayList<Enero> lista) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            System.out.println("Para el " + lista.get(i).mostrarDiaSemana() + " dÃ­a " + lista.get(i).mostrarDia() + " Hizo una temperatura de " + lista.get(i).mostrarTemperaturaMedia());
        }
    }
    ...
    public static void diasMasCaluroso(ArrayList<Enero> lista) {
        ...
        System.out.println("---------Los dÃ­as mÃ¡s calurosos son------------");
        for (int i = 0; i < lista.size(); i++) {
    ...
    public static void main(String[] args) {
        ...
        String respuesta;
        do {
            System.err.println("Datos del dÃ­a: ");
            lista.add(new Enero());
            System.out.println("Desea introducir otro dÃ­a [SI / NO]");
