//Escribe un programa que contenga un método que acepte como parámetro una lista de números enteros mayores que 0, pudiendo contener elementos duplicados.
//Este método debe sustituir cada valor repetido por 0.
//Para terminar, realiza un método muestre el array modificado.
//Nota: Necesitarás otro método para rellenar la lista de enteros. Le irá pidiendo números al usuario hasta que este introduzca un número negativo.
...
public class SustituirPorCeros {
    ...
    public static void solicitarNumeros(ArrayList<Integer> listaNumeros) {
        ...
        System.out.println("------Lista de nÃºmeros Enteros----------");
        do {
            if (contador == true) {
            ...
            System.out.println("Si quieres dejar de meter nÃºmeros escribe: \"Si\"");
            salir = teclado.next();
